const Products = [
  ...
  },
  {
    ...
    des:
      " miss A가 세 번째 미니앨범이자 일곱 번째 프로젝트 앨범 [Colors]로 돌아온다.\n 1년 5개월 만에 돌아온 그녀들 miss A! 지난 앨범 [허쉬]로 어쿠스틱한 분위기와 인상적인 곡으로 속삭이는 듯한 가사와 몽환적인 멜로디로 사랑을 받았던 miss A이기에 이번 컴백 앨범에 대한 기대감을 더욱 고조시키고 있다. \n 세 번째 미니 앨범의 타이틀곡 다른 남자 말고 너 는 대중적인 힙합과 트랙 리듬이 인상적인 곡으로 여자들의 적극적인 사랑방식을 대변해주는 곡이다.\n 이외에도, Retro Neo Soul의 장르의 곡으로 Urban 느낌의 Intro, 저음의 Groove와 EP와 어쿠스틱 피아노의 라인이 돋보이는 매력적인 곡 한걸음, 트랩(Trap) 비트에 어우러진 바이올린의 콤비네이션으로 애절함과 요염함의 경계를 미묘하게 넘나드는 유혹의 노래 Love Song, 섹시하면서도 절제된 감성으로 심플하고 강렬한 곡과 세련된 멜로디로 아무로 나미에 등 국내외 수많은 히트곡들로 유명한 노르웨이의 프로듀서 그룹 Dsign Music의 작품 녹아, miss A 멤버 수지가 작사한 곡으로 바람 피는 장면을 직접 눈앞에서 목격한 모습을 재미있게 묘사한 '딱 걸렸어' 의미에 I Caught Ya, miss A 멤버 민이 작사한 곡으로 다른 사람과 만나도 괜찮을까라는 위험한 사랑 이야기를 담은 Stuck 총 6곡이 수록되었다. \n 한층 더 성숙한 모습으로 1년 5개월 만에 컴백한 miss A가 신규 앨범 [Colors]로 팬들을 찾아간다.",
    property: "Music",
  },
  {
    id: 14,
